...
My name is Antonis Geralis. I am a graduate.
...
| :-: | :-: | --- | :-: |
| 7/4/26 | Architecting Games in Nim: A Pragmatic Guide | Plain structs, arrays, and procs — why most games never need ECS, and what to use instead. | [full text](https://planetisrocks.blogspot.com/2026/07/architecting-games-in-nim-pragmatic.html) |
...
| [smartcli](https://github.com/planetis-m/smartcli) | Turns a help text block into a small CLI parser and a typed options object. |
| [dokime](https://github.com/planetis-m/dokime) | SQL that won't compile if it's wrong — validates queries against your real database at compile time. |
